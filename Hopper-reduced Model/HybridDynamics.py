...
#
#
#trjs,disc1 = HybridDynamics(y0, z0, p, K, T, rx,dt)
#k = []; t = []; j = []; x = []
#t1 = []; O = []
#k,t,j,x_d = obs(trjs,True, True, None, p)
#
#tt = []
#for time in range(0,232):
#    tt.append(time*dt)
#
#
#plt.plot(tt,disc1)
...
#plt.legend(loc = 'bottom right', labels = ['phaseF', 'phaseB', 'COT'])
#plt.title('Jump Map for Bounding Quadruped- Python')
...
#plt.xlabel('Time (s)')
#plt.ylabel('States')
#plt.title('Flow Map for Bounding Quadruped- Python')
#plt.legend(labels = ['x', 'dx', 'y', 'dy', 'phi', 'dphi', 'alphaF', 'dalphaF', 'lF', 'dlF', 'alphaB', 'dalphaB', 'lB', 'dlB', 'time', 'posWork'],prop={'size':9})
#
